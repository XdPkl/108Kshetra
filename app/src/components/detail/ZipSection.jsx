 ...
 * gold gradient top strip, ruled heading row with an optional right badge.
 * @param {object} props
 ...
 */
export default function ZipSection({ id, title, badge = null, children }) {
  return (
    <section
      id={id}
    ...
    >
      ...
      <div className="border-b border-[#F0E3C6] pb-3 mb-6 flex items-center justify-between flex-wrap gap-2">
        <h2 className="font-display text-2xl sm:text-[1.7rem] font-semibold text-[#7A2E00]">
          {title}
        </h2>
        {badge}
      </div>
