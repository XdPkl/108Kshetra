...
| 1.6 | 2026-08-30 | Dev Team | Divya Desam dossier population: 93 kshetrams carry full dossier shrine templates (profile, deities, puranam, mangalasasanam with per-Azhwar counts and excerpts, visuals); 3 dossier photographs wired in; 15 kshetrams keep V2 enrichment pending PO follow-up |
| 1.5 | 2026-08-30 | Dev Team | Kshetram detail layout extensions for the Divya Desam dossier population: multi-Thaayar deity entries (`thaayar` object or array), direct-`src` photos in the deity strips (WikiThumb), Prathyaksham subsection in Sthala Puranam, Azhwars-Who-Glorified links now point to per-Azhwar detail pages; Divya Desam dossiers (#1–#108) archived in Reference Content |
